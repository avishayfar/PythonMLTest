...
ew = pandas.ExcelWriter('C:\\FRD\\FRDTransactionResults71.xlsx')
...
ew = pandas.ExcelWriter('C:\\FRD\\FRDTransactionResults72.xlsx')
...
predictlDf.to_excel(ew, sheet_name='LR Predict')
flagDf.to_excel(ew, sheet_name='LR Flag')
...
predictlDf.to_excel(ew, sheet_name='GaussianNB')
